...
public class personal_details_parent extends AppCompatActivity {
    ...
    private TextInputEditText work_experience_p;
    ...
    private TextInputEditText any_other_degree__p;
    Button btn_next;
...
work_experience_p=(TextInputEditText)findViewById(R.id.any_other_teaching_parent);
...
any_other_degree__p=(TextInputEditText)findViewById(R.id.chosee_parent) ;
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                user.put("work experience", work_experience_p.getText().toString().trim()) ;
                user.put("graduation", graduation_p.getText().toString().trim()) ;
                user.put("post graduation", post_graduation__p.getText().toString().trim()) ;
                user.put("other degree", any_other_degree__p.getText().toString().trim()) ;
